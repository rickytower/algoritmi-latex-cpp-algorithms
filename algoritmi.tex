...
\begin{lstlisting}[numbers=none,caption={esempio.}]
	Supponiamo di avere un array:
	A = [3, 1, 4, 2, 5]
	e vogliamo trovare il minimo di ogni sottovettore di lunghezza M = 3.
	
	Passo 1: Inizializzazione
	Aggiungiamo i primi 3 elementi alla coda modificata:
	[3, 1, 4] → il minimo è 1
	
	Passo 2: Scorrimento
	Rimuoviamo il primo elemento (3) e aggiungiamo il successivo (2):
	[1, 4, 2] → il minimo è 1
	
	Passo 3: Scorrimento
	Rimuoviamo il primo (1) e aggiungiamo il successivo (5):
	[4, 2, 5] → il minimo è 2
	
	Risultato finale:
	Minimi dei sottovettori: [1, 1, 2]
\end{lstlisting}
\end{document}